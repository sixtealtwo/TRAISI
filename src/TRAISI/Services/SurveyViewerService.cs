...
namespace TRAISI.Services
{
    public class SurveyViewerService : ISurveyViewerService
    {
        ...
        /// <param name="shortcode"></param>
        /// <returns></returns>
        public async Task<(bool loginSuccess, SurveyUser user)> SurveyLogin
        (Survey survey, string shortcode, ClaimsPrincipal currentUser, string userAgent, JObject queryParams)
        {
