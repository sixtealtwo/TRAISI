...
export class QuestionClient {
	...
	customBuilderClientCode(
		questionType: string | null
	): Observable<FileResponse> {
		let url_ =
			this.baseUrl + "/api/Question/client-code/builder/{questionType}";
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processCustomBuilderClientCode(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processCustomBuilderClientCode(
	...
	clientBuilderCode(questionType: string | null): Observable<FileResponse> {
		let url_ =
			this.baseUrl + "/api/Question/client-builder-code/{questionType}";
		if (questionType === undefined || questionType === null)
			throw new Error("The parameter 'questionType' must be defined.");
		url_ = url_.replace(
			"{questionType}",
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processClientBuilderCode(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processClientBuilderCode(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
				...
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							...
							return <Observable<QuestionTypeDefinition[]>>(
								(<any>_observableThrow(e))
							);
						}
					} else
	...
	protected processQuestionTypes(
		response: HttpResponseBase
	): Observable<QuestionTypeDefinition[]> {
		const status = response.status;
		const responseBlob =
			response instanceof HttpResponse
				? response.body
...
export class SurveyBuilderClient {
				...
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							...
							return <
								Observable<SBQuestionTypeDefinitionViewModel[]>
							>(<any>_observableThrow(e));
						}
					} else
						return <
			...
			return blobToText(responseBlob).pipe(
				_observableMergeMap(_responseText => {
					...
					result200 =
						_responseText === ""
							? null
							: <SBQuestionTypeDefinitionViewModel[]>(
									JSON.parse(
										_responseText,
										this.jsonParseReviver
									)
	...
	generateCATIView(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/GenerateCATIView/{language}";
				...
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							...
							return <Observable<SBSurveyViewViewModel>>(
								(<any>_observableThrow(e))
							);
						}
					} else
	...
	protected processGenerateCATIView(
		response: HttpResponseBase
	): Observable<SBSurveyViewViewModel> {
		const status = response.status;
		const responseBlob =
	...
	deleteCATIView(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/DeleteCATIView/{language}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (language === undefined || language === null)
	...
	protected processDeleteCATIView(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	getSurveyViewPageStructure(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/PageStructure/{surveyViewName}/{language}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		...
		url_ = url_.replace(
			"{surveyViewName}",
			encodeURIComponent("" + surveyViewName)
		);
		if (language === undefined || language === null)
			throw new Error("The parameter 'language' must be defined.");
		url_ = url_.replace("{language}", encodeURIComponent("" + language));
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processGetSurveyViewPageStructure(
								<any>response_
							);
						} catch (e) {
							return <Observable<SBSurveyViewViewModel>>(
	...
	protected processGetSurveyViewPageStructure(
		response: HttpResponseBase
	): Observable<SBSurveyViewViewModel> {
		const status = response.status;
		const responseBlob =
	...
	updateSurveyViewPageOrder(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/PageStructure/{surveyViewName}/UpdateOrder/{pageViewId}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (surveyViewName === undefined || surveyViewName === null)
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processUpdateSurveyViewPageOrder(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processUpdateSurveyViewPageOrder(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	addQuestionPartView(
		...
		if (
			parentQuestionPartViewId === undefined ||
			parentQuestionPartViewId === null
		)
			throw new Error(
				"The parameter 'parentQuestionPartViewId' must be defined."
			);
		url_ = url_.replace(
			"{parentQuestionPartViewId}",
			encodeURIComponent("" + parentQuestionPartViewId)
		);
		if (initialLanguage === undefined || initialLanguage === null)
			throw new Error("The parameter 'initialLanguage' must be defined.");
		url_ = url_.replace(
			"{initialLanguage}",
			encodeURIComponent("" + initialLanguage)
		);
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processAddQuestionPartView(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processAddQuestionPartView(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	deleteQuestionPartView(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/Part/{parentQuestionPartViewId}/{childQuestionPartViewId}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (
		...
		if (
			childQuestionPartViewId === undefined ||
			childQuestionPartViewId === null
		)
			throw new Error(
				"The parameter 'childQuestionPartViewId' must be defined."
			);
		url_ = url_.replace(
			"{childQuestionPartViewId}",
			encodeURIComponent("" + childQuestionPartViewId)
		);
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processDeleteQuestionPartView(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processDeleteQuestionPartView(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processUpdateQuestionPartViewData(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processUpdateQuestionPartViewData(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	getQuestionPartViewStructure(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/PartStructure/{questionPartViewId}/{language}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (questionPartViewId === undefined || questionPartViewId === null)
			throw new Error(
				"The parameter 'questionPartViewId' must be defined."
			);
		url_ = url_.replace(
			"{questionPartViewId}",
			encodeURIComponent("" + questionPartViewId)
		);
		if (language === undefined || language === null)
			throw new Error("The parameter 'language' must be defined.");
		url_ = url_.replace("{language}", encodeURIComponent("" + language));
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processGetQuestionPartViewStructure(
								<any>response_
							);
						} catch (e) {
							return <Observable<SBQuestionPartViewViewModel>>(
								(<any>_observableThrow(e))
							);
						}
					} else
	...
	protected processGetQuestionPartViewStructure(
		response: HttpResponseBase
	): Observable<SBQuestionPartViewViewModel> {
		const status = response.status;
		const responseBlob =
	...
	getQuestionPartConfigurations(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/QuestionConfigurations/{questionPartId}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		...
		url_ = url_.replace(
			"{questionPartId}",
			encodeURIComponent("" + questionPartId)
		);
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processGetQuestionPartConfigurations(
								<any>response_
							);
						} catch (e) {
							return <
								Observable<
									QuestionConfigurationValueViewModel[]
								>
							>(<any>_observableThrow(e));
						}
					} else
	...
	updateQuestionPartConfigurations(
		...
		return this.http
			...
			.pipe(
				_observableMergeMap((response_: any) => {
					return this.processUpdateQuestionPartConfigurations(
						response_
					);
				})
			)
	...
	protected processUpdateQuestionPartConfigurations(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	getQuestionPartConditionals(
		surveyId: number,
		questionPartId: number
	): Observable<QuestionConditionalViewModel[]> {
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/QuestionConditionals/{questionPartId}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (questionPartId === undefined || questionPartId === null)
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processGetQuestionPartConditionals(
								<any>response_
							);
						} catch (e) {
							return <Observable<QuestionConditionalViewModel[]>>(
								(<any>_observableThrow(e))
							);
						}
					} else
	...
	protected processGetQuestionPartConditionals(
		response: HttpResponseBase
	): Observable<QuestionConditionalViewModel[]> {
		const status = response.status;
		const responseBlob =
	...
	setQuestionPartConditionals(
		surveyId: number,
		questionPartId: number,
		conditionals: QuestionConditionalViewModel[] | null
	): Observable<FileResponse> {
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/QuestionConditionals/{questionPartId}";
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processSetQuestionPartConditionals(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processSetQuestionPartConditionals(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	getQuestionPartOptionConditionals(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/QuestionOptionConditionals/{questionPartId}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (questionPartId === undefined || questionPartId === null)
		...
		return this.http
			...
			.pipe(
				_observableMergeMap((response_: any) => {
					return this.processGetQuestionPartOptionConditionals(
						response_
					);
				})
			)
			...
			return blobToText(responseBlob).pipe(
				_observableMergeMap(_responseText => {
					...
					result200 =
						_responseText === ""
							? null
							: <QuestionOptionConditionalViewModel[]>(
									JSON.parse(
										_responseText,
										this.jsonParseReviver
									)
	...
	setQuestionPartOptionConditionals(
		...
		return this.http
			...
			.pipe(
				_observableMergeMap((response_: any) => {
					return this.processSetQuestionPartOptionConditionals(
						response_
					);
				})
			)
	...
	protected processSetQuestionPartOptionConditionals(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	getSurveyViewPagesWithQuestionsAndOptions(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/PageStructure/{surveyViewName}/{language}/QuestionsOptions";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (surveyViewName === undefined || surveyViewName === null)
		...
		return this.http
			...
			.pipe(
				_observableMergeMap((response_: any) => {
					return this.processGetSurveyViewPagesWithQuestionsAndOptions(
						response_
					);
				})
			)
				...
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							...
							return <Observable<SBPageStructureViewModel[]>>(
								(<any>_observableThrow(e))
							);
						}
					} else
	...
	getQuestionPartOptions(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/QuestionOptions/{questionPartId}/{language}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (questionPartId === undefined || questionPartId === null)
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processGetQuestionPartOptions(
								<any>response_
							);
						} catch (e) {
							return <Observable<QuestionOptionValueViewModel[]>>(
								(<any>_observableThrow(e))
							);
						}
					} else
	...
	protected processGetQuestionPartOptions(
		response: HttpResponseBase
	): Observable<QuestionOptionValueViewModel[]> {
		const status = response.status;
		const responseBlob =
	...
	setQuestionPartOption(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/QuestionOptions/{questionPartId}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (questionPartId === undefined || questionPartId === null)
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processSetQuestionPartOption(
								<any>response_
							);
						} catch (e) {
							return <Observable<QuestionOptionValueViewModel>>(
	...
	protected processSetQuestionPartOption(
		response: HttpResponseBase
	): Observable<QuestionOptionValueViewModel> {
		const status = response.status;
		const responseBlob =
	...
	importQuestionPartOptions(
		surveyId: number,
		questionPartId: number
	): Observable<FileResponse> {
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/QuestionOptions/{questionPartId}/massImport";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (questionPartId === undefined || questionPartId === null)
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processImportQuestionPartOptions(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processImportQuestionPartOptions(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	deleteQuestionPartOption(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/QuestionOptions/{questionPartId}/{optionId}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (questionPartId === undefined || questionPartId === null)
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processDeleteQuestionPartOption(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processDeleteQuestionPartOption(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	updateQuestionPartOptionsOrder(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/QuestionOptions/{questionPartId}/Order";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (questionPartId === undefined || questionPartId === null)
		...
		return this.http
			...
			.pipe(
				_observableMergeMap((response_: any) => {
					return this.processUpdateQuestionPartOptionsOrder(
						response_
					);
				})
			)
	...
	protected processUpdateQuestionPartOptionsOrder(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	updateQuestionPartViewOrder(
		...
		if (
			questionPartViewMovedId === undefined ||
			questionPartViewMovedId === null
		)
			throw new Error(
				"The parameter 'questionPartViewMovedId' must be defined."
			);
		url_ = url_.replace(
			"{questionPartViewMovedId}",
			encodeURIComponent("" + questionPartViewMovedId)
		);
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processUpdateQuestionPartViewOrder(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processUpdateQuestionPartViewOrder(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	protected processGetSurveyStyles(
		response: HttpResponseBase
	): Observable<string> {
		const status = response.status;
		const responseBlob =
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processUpdateSurveyStyles(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processUpdateSurveyStyles(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processExtensionConfiguration(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processExtensionConfiguration(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processExtensionConfiguration2(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processExtensionConfiguration2(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	extensionConfiguration3(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/extensions/{extensionName}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processExtensionConfiguration3(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processExtensionConfiguration3(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processExtensionConfiguration4(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processExtensionConfiguration4(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	getWelcomePageLabel(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/WelcomePage/{surveyViewName}/{language}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (surveyViewName === undefined || surveyViewName === null)
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processGetWelcomePageLabel(
								<any>response_
							);
						} catch (e) {
							return <Observable<WelcomePageLabelViewModel>>(
								(<any>_observableThrow(e))
							);
						}
					} else
	...
	protected processGetWelcomePageLabel(
		response: HttpResponseBase
	): Observable<WelcomePageLabelViewModel> {
		const status = response.status;
		const responseBlob =
	...
	getThankYouPageLabel(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/ThankYouPage/{surveyViewName}/{language}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (surveyViewName === undefined || surveyViewName === null)
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processGetThankYouPageLabel(
								<any>response_
							);
						} catch (e) {
							return <Observable<ThankYouPageLabelViewModel>>(
								(<any>_observableThrow(e))
							);
						}
					} else
	...
	protected processGetThankYouPageLabel(
		response: HttpResponseBase
	): Observable<ThankYouPageLabelViewModel> {
		const status = response.status;
		const responseBlob =
	...
	getTermsAndConditionsPageLabel(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/TermsAndConditionsPage/{surveyViewName}/{language}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (surveyViewName === undefined || surveyViewName === null)
		...
		return this.http
			...
			.pipe(
				_observableMergeMap((response_: any) => {
					return this.processGetTermsAndConditionsPageLabel(
						response_
					);
				})
			)
			...
			return blobToText(responseBlob).pipe(
				_observableMergeMap(_responseText => {
					...
					result200 =
						_responseText === ""
							? null
							: <TermsAndConditionsPageLabelViewModel>(
									JSON.parse(
										_responseText,
										this.jsonParseReviver
									)
	...
	getScreeningQuestionsLabel(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/ScreeningQuestions/{surveyViewName}/{language}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (surveyViewName === undefined || surveyViewName === null)
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processGetScreeningQuestionsLabel(
								<any>response_
							);
						} catch (e) {
							return <
						...
						return <Observable<ScreeningQuestionsLabelViewModel>>(
							(<any>_observableThrow(response_))
						);
				})
			);
			...
			return blobToText(responseBlob).pipe(
				_observableMergeMap(_responseText => {
					...
					result200 =
						_responseText === ""
							? null
							: <ScreeningQuestionsLabelViewModel>(
									JSON.parse(
										_responseText,
										this.jsonParseReviver
									)
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processUpdateWelcomePageLabel(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processUpdateWelcomePageLabel(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processUpdateThankYouPageLabel(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processUpdateThankYouPageLabel(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	updateSurveyTitleLabel(
		...
		let url_ =
			this.baseUrl + "/api/SurveyBuilder/{surveyId}/title/{title}?";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processUpdateSurveyTitleLabel(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processUpdateSurveyTitleLabel(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	updateTermsAndConditionsPageLabel(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/TermsAndConditionsPage";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.http
			...
			.pipe(
				_observableMergeMap((response_: any) => {
					return this.processUpdateTermsAndConditionsPageLabel(
						response_
					);
				})
			)
	...
	protected processUpdateTermsAndConditionsPageLabel(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	updateScreeningQuestionsLabel(
		...
		let url_ =
			this.baseUrl + "/api/SurveyBuilder/{surveyId}/ScreeningQuestions";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		url_ = url_.replace(/[?&]$/, "");
		...
		return this.http
			...
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processUpdateScreeningQuestionsLabel(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processUpdateScreeningQuestionsLabel(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	addPage(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/Page/{surveyViewName}/{initialLanguage}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (surveyViewName === undefined || surveyViewName === null)
	...
	deletePage(
		...
		let url_ =
			this.baseUrl +
			"/api/SurveyBuilder/{surveyId}/Page/{surveyViewName}/{pageId}";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (surveyViewName === undefined || surveyViewName === null)
	...
	addConditionalOperator(
		surveyId: number,
		questionPartViewId: number,
		conditional: QuestionConditionalOperator | null
	): Observable<FileResponse> {
		let url_ = this.baseUrl + "/api/SurveyBuilder/{surveyId}/conditionals?";
		if (surveyId === undefined || surveyId === null)
			throw new Error("The parameter 'surveyId' must be defined.");
		url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
		if (questionPartViewId === undefined || questionPartViewId === null)
			throw new Error(
				"The parameter 'questionPartViewId' must be defined and cannot be null."
			);
		else
			url_ +=
				"questionPartViewId=" +
		...
		const content_ = JSON.stringify(conditional);
		...
		return this.http
			...
			.pipe(
				_observableMergeMap((response_: any) => {
					return this.processAddConditionalOperator(response_);
				})
			)
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processAddConditionalOperator(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processAddConditionalOperator(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
	...
	deleteConditionalOperator(
		...
		return this.http
			...
			.pipe(
				_observableMergeMap((response_: any) => {
					return this.processDeleteConditionalOperator(response_);
				})
			)
			.pipe(
				_observableCatch((response_: any) => {
					if (response_ instanceof HttpResponseBase) {
						try {
							return this.processDeleteConditionalOperator(
								<any>response_
							);
						} catch (e) {
							return <Observable<FileResponse>>(
	...
	protected processDeleteConditionalOperator(
		response: HttpResponseBase
	): Observable<FileResponse> {
		const status = response.status;
		const responseBlob =
...
export interface SBQuestionTypeDefinitionViewModel {
	typeName?: string | undefined;
	questionOptions?:
		| { [key: string]: QuestionOptionDefinitionViewModel }
		| undefined;
	questionConfigurations?:
		| { [key: string]: QuestionConfigurationDefinitionViewModel }
		| undefined;
	icon?: string | undefined;
...
export interface QuestionConfiguration {
	...
	valueType?: ConfigurationValueType;
	questionConfigurationLabels?:
		| LabelCollectionOfQuestionConfigurationLabel
		| undefined;
...
export interface LabelCollectionOfQuestionConfigurationLabel
	extends Anonymous {}
...
export interface SurveyView {
	...
	termsAndConditionsLabels?:
		| LabelCollectionOfTermsAndConditionsPageLabel
		| undefined;
	thankYouPageLabels?: LabelCollectionOfThankYouPageLabel | undefined;
	screeningQuestionLabels?:
		| LabelCollectionOfScreeningQuestionsPageLabel
		| undefined;
	viewName?: string | undefined;
}
...
export interface LabelCollectionOfTermsAndConditionsPageLabel
	extends Anonymous6 {}
...
export interface LabelCollectionOfScreeningQuestionsPageLabel
	extends Anonymous8 {}
