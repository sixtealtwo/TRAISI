							...
							e &&
								('cachedDataRejected' === e.errorCode
									...
									: 'unlink' === e.errorCode || 'writeFile' === e.errorCode
										? (console.error('Problems writing cached data file: ' + e.path), console.error(e.detail))
										: console.error(e));
						}),
					t
				);
			...
			return (
						...
						(n = e.Utilities.fileUriToFilePath(this._env.isWindows, n)),
							this._fs.readFile(n, { encoding: 'utf8' }, function(e, a) {
								if (e) i(e);
									...
									if (
										((p = a.charCodeAt(0) === t._BOM ? _ + a.substring(1) + '\n});' : _ + a + '\n});'),
										(p = u(p, c)),
										d.nodeCachedDataDir)
									) {
				...
				(t.prototype._loadAndEvalScript = function(t, r, n, o, i, s) {
					...
					return (
						d
							.runInThisContext(i)
							.call(e.global, t.getGlobalAMDRequireFunc(), t.getGlobalAMDDefineFunc(), n, this._path.dirname(r)),
						s.record(32, r),
						d
					);
				}),
						...
						if (d !== o.MODULE)
							if (d !== o.REQUIRE) {
								...
								if (a && a.isComplete()) e.unresolvedDependenciesCount--;
									...
									c || ((c = []), this._inversePluginDependencies2.set(d.pluginId, c)),
										c.push(d),
...
!(function(e) {
	...
	(s.config = i),
		...
		(e.init = t),
			((n = new e.ModuleManager(r, e.createScriptLoader(r), o, s, e.Utilities.getHighPerformanceTimestamp())),
