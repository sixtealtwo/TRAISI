...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Groups.GroupMember", b =>
                {
                    b.HasOne("DAL.Models.TraisiUser", null)
                        .WithMany("Groups")
            ...
            modelBuilder.Entity("DAL.Models.Questions.QuestionConditionalOperator", b =>
                {
                    b.HasOne("DAL.Models.Questions.QuestionConditional", "Lhs")
                        .WithOne()
                        .HasForeignKey("DAL.Models.Questions.QuestionConditionalOperator", "LhsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("DAL.Models.Questions.QuestionConditional", "Rhs")
                        .WithOne()
                        .HasForeignKey("DAL.Models.Questions.QuestionConditionalOperator", "RhsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.Models.Questions.QuestionConfigurationLabel", b =>
                {
                    b.HasOne("DAL.Models.Questions.QuestionConfiguration", null)
            ...
            modelBuilder.Entity("DAL.Models.ResponseTypes.ResponseValue", b =>
                {
                    b.HasOne("DAL.Models.ResponseTypes.OptionListResponse", null)
