...
namespace TRAISI.Migrations
{
    ...
    [Migration("20200327065141_AddCascadeDeleteForConditionals")]
    partial class AddCascadeDeleteForConditionals
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TRAISI.Data.Models.Questions.QuestionConditionalGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TRAISI.Data.Models.ResponseTypes.DecimalResponse", b =>
                {
                    b.HasBaseType("TRAISI.Data.Models.ResponseTypes.ResponseValue");
            ...
            modelBuilder.Entity("TRAISI.Data.Models.ResponseTypes.IntegerResponse", b =>
                {
                    b.HasBaseType("TRAISI.Data.Models.ResponseTypes.ResponseValue");
            ...
            modelBuilder.Entity("TRAISI.Data.Models.ResponseTypes.PathResponse", b =>
                {
                    b.HasBaseType("TRAISI.Data.Models.ResponseTypes.ResponseValue");
            ...
            modelBuilder.Entity("TRAISI.Data.Models.Questions.QuestionConditional", b =>
                {
                    ...
                    b.HasOne("TRAISI.Data.Models.Questions.QuestionPartView", "SourceQuestion")
                        .WithOne()
                        .HasForeignKey("TRAISI.Data.Models.Questions.QuestionConditional", "SourceQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TRAISI.Data.Models.Questions.QuestionConditionalOperator", b =>
                {
                    b.HasOne("TRAISI.Data.Models.Questions.QuestionConditional", "Lhs")
                        .WithOne()
                        .HasForeignKey("TRAISI.Data.Models.Questions.QuestionConditionalOperator", "LhsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TRAISI.Data.Models.Questions.QuestionConditionalGroup", null)
                    ...
                    b.HasOne("TRAISI.Data.Models.Questions.QuestionConditional", "Rhs")
                        .WithOne()
                        .HasForeignKey("TRAISI.Data.Models.Questions.QuestionConditionalOperator", "RhsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
