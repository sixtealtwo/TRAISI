...
namespace TRAISI.Migrations
{
    ...
    [Migration("20191001104329_AddTimelineOrderOptional")]
    partial class AddTimelineOrderOptional
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TRAISI.Data.Models.Groups.GroupMember", b =>
                {
                    b.HasOne("TRAISI.Data.Models.TraisiUser")
                        .WithMany("Groups")
            ...
            modelBuilder.Entity("TRAISI.Data.Models.Questions.QuestionConditional", b =>
                {
                    ...
                    b.HasOne("TRAISI.Data.Models.Questions.QuestionPart", "TargetQuestion")
            ...
            modelBuilder.Entity("TRAISI.Data.Models.Questions.QuestionConfiguration", b =>
                {
                    b.HasOne("TRAISI.Data.Models.Questions.QuestionPart")
            ...
            modelBuilder.Entity("TRAISI.Data.Models.Questions.QuestionConfigurationLabel", b =>
                {
                    b.HasOne("TRAISI.Data.Models.Questions.QuestionConfiguration")
            ...
            modelBuilder.Entity("TRAISI.Data.Models.ResponseTypes.ResponseValue", b =>
                {
                    b.HasOne("TRAISI.Data.Models.ResponseTypes.OptionListResponse")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("TRAISI.Data.Models.ApplicationRole")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TRAISI.Data.Models.ApplicationUser")
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
