...
namespace Traisi.Data.Core.Interfaces
{
	public interface IAccountManager
	{
		...
		Task<Tuple<bool, string[], SurveyUser>> CreateSurveyUserAsync(SurveyUser user, Shortcode shortcodeRef, string shortcode,
		 (string claimName, string claimValue)[] claims);
		...
		Task<SurveyUser> GetSurveyUserByShortcodeAsync(int surveyId, string shortocde);
