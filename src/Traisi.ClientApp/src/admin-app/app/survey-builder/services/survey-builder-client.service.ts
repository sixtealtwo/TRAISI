...
export class SurveyBuilderClient {
    ...
    uploadSurveyImage(surveyId: number, imageData: string | null): Observable<SurveyLogicRulesModel[]> {
        let url_ = this.baseUrl + "/api/SurveyBuilder/surveys/{surveyId}/image";
        if (surveyId === undefined || surveyId === null)
            throw new Error("The parameter 'surveyId' must be defined.");
        url_ = url_.replace("{surveyId}", encodeURIComponent("" + surveyId));
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(imageData);
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUploadSurveyImage(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUploadSurveyImage(<any>response_);
                } catch (e) {
                    return <Observable<SurveyLogicRulesModel[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUploadSurveyImage(response: HttpResponseBase): Observable<SurveyLogicRulesModel[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export interface SBQuestionTypeDefinitionViewModel {
    typeName?: string | null;
    questionOptions?: { [key: string]: QuestionOptionDefinitionViewModel; } | null;
    questionConfigurations?: { [key: string]: QuestionConfigurationDefinitionViewModel; } | null;
    icon?: string | null;
    responseType?: string | null;
    typeNameLocales?: { [key: string]: string; } | null;
    hasCustomBuilderView?: boolean;
    customBuilderViewName?: string | null;
}
...
export interface SBSurveyViewViewModel {
    ...
    pages?: SBQuestionPartViewViewModel[] | null;
    termsAndConditionsPage?: TermsAndConditionsPageLabelViewModel | null;
    welcomePage?: WelcomePageLabelViewModel | null;
    surveyCompletionPage?: ThankYouPageLabelViewModel | null;
    screeningQuestions?: ScreeningQuestionsLabelViewModel | null;
}

export interface SBQuestionPartViewViewModel {
    id?: number;
    questionPart?: SBQuestionPartViewModel | null;
    label?: LabelViewModel | null;
    descriptionLabel?: LabelViewModel | null;
    parentViewId?: number | null;
    questionPartViewChildren?: SBQuestionPartViewViewModel[] | null;
    order?: number;
    isOptional?: boolean;
    isHousehold?: boolean;
    repeatSourceQuestionName?: string | null;
    repeatSourceQuestionId?: number | null;
    icon?: string | null;
    isMultiView?: boolean;
    catiDependent?: SBQuestionPartViewViewModel | null;
}
...
export interface SBQuestionPartViewModel {
    ...
    name?: string | null;
    questionPartChildren?: SBQuestionPartViewModel[] | null;
...
export interface QuestionConditionalOperatorViewModel {
    lhs?: QuestionConditionalViewModel | null;
    rhs?: QuestionConditionalViewModel | null;
    id?: number;
    order?: number;
...
export interface SBPageStructureViewModel {
    ...
    type?: string | null;
    children?: SBPageStructureViewModel[] | null;
}
...
export interface QuestionOptionValueViewModel {
    ...
    name?: string | null;
    code?: string | null;
    optionLabel?: LabelViewModel | null;
    order?: number;
}
...
export interface SurveyLogicViewModel extends SurveyLogicBaseViewModel {
    ...
    message?: string | null;
    condition?: string | null;
    rules?: SurveyLogicViewModel[] | null;
    field?: string | null;
    ...
    rootId?: number | null;
    entity?: string | null;
    validationQuestionId?: number | null;
}
...
export interface SurveyLogicRulesModel extends SurveyLogicBaseViewModel {
    ...
    message?: string | null;
    condition?: string | null;
    rules?: SurveyLogicBaseViewModel[] | null;
    field?: string | null;
    operator?: string | null;
    value?: any | null;
    parentId?: number | null;
