    ...
    public class SurveyRepository : Repository<Survey>, ISurveyRepository
    {
        ...
        public async Task<Survey> GetSurveyFullAsync(int surveyId)
        {
            return await _appContext.Surveys.Where(s => s.Id == surveyId)
                ...
                .Include(s => s.SurveyViews).ThenInclude(v => v.QuestionPartViews).ThenInclude(q => q.QuestionPartViewChildren).ThenInclude(q2 => q2.QuestionPart).ThenInclude(qp => qp.QuestionConfigurations)
